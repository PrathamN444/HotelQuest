        ...
        <div>
            <form>
                ...
                <div className="mt-2 grid grid-cols-3 md:grid-cols-6 lg:grid-cols-8 gap-2">
                    <label className="cursor-pointer border bg-transparent p-7 rounded-2xl text-gray-500 text-xl border-gray-500 hover:shadow-md flex items-center justify-center gap-2">
